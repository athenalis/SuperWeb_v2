...
/* =========================
   MAIN COMPONENT
========================= */
export default function RelawanApkDetail() {
    ...
    api
      ...
      .catch((err) => {
        if (err.response?.status === 404) {
          setNotFound(true);
          toast.error("Data relawan APK tidak ditemukan");
        } else {
      ...
      <div className="p-10 text-center text-slate-600">
        ...
        <div className="mt-4">
          <button
            ...
            className="px-5 py-2 rounded-lg bg-slate-200 text-slate-800 hover:bg-slate-300 transition"
          >
            Kembali
          </button>
        </div>
      ...
      <div className="w-full max-w-8xl bg-white rounded-xl shadow p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8 lg:space-y-12">
        ...
        <div className="relative pt-2 sm:pt-4 flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4 border-b pb-4 sm:pb-6 lg:pb-8">
          ...
          <div className="flex items-center gap-2 sm:gap-3 w-full md:w-auto">
            {role !== "admin" && (
              <button
                onClick={() => navigate(`/relawan/apk/${id}/edit`)}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
          ...
          <div className="space-y-4 sm:space-y-6 lg:space-y-8">
            ...
            {/* OPTIONAL CARD: ID / META */}
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-5 lg:p-6 border border-slate-200 space-y-3">
